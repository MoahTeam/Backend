...
from .views import delete_button3_view, error_page, success_page

from todo.views import delete_button2_view, delete_button_view, djangocreate, moahtodo, todo_create_view, todo_list_view, todo_new_view, todo_save_view
app_name = 'todo'
